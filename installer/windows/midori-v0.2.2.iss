#define MyAppId "midori.language.compiler.v022"
...
LicenseFile=..\..\LICENSE
AllowNoIcons=yes
OutputDir=output\v0.2.2
OutputBaseFilename=midori-setup-v0.2.2
...
DisableDirPage=no
SetupLogging=yes
UninstallDisplayName=MIDORI 0.2.2
...
[Code]
const
  MidoriRegPath = 'Software\MIDORI\v0.2.2';

#define MyAppId "midori.language.compiler.v021"
...
LicenseFile=..\..\LICENSE
AllowNoIcons=yes
OutputDir=output\v0.2.1
OutputBaseFilename=midori-setup-v0.2.1
...
DisableDirPage=no
SetupLogging=yes
UninstallDisplayName=MIDORI 0.2.1
...
[Files]
Source: "..\..\src\*"; DestDir: "{app}\src"; Excludes: "__pycache__\*,*.pyc,*.pyo"; Flags: recursesubdirs createallsubdirs ignoreversion; Components: core
...
Source: "..\..\tests\*"; DestDir: "{app}\tests"; Excludes: "__pycache__\*,*.pyc,*.pyo"; Flags: recursesubdirs createallsubdirs ignoreversion; Components: devtools
...
[Code]
const
  MidoriRegPath = 'Software\MIDORI\v0.2.1';
